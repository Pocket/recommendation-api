# encoding: utf-8
# module scipy.sparse.linalg._propack._dpropack
# from /.venv/lib/python3.8/site-packages/scipy/sparse/linalg/_propack/_dpropack.cpython-38-aarch64-linux-gnu.so
# by generator 1.147
"""
...
def dlansvd(jobu, jobv, m, n, k, aprod, u, v, tolin, work, iwork, doption, ioption, dparm, iparm, kmax=None, ldu=None, ldv=None, lwork=None, liwork=None, aprod_extra_args=None): # real signature unknown; restored from __doc__
    """
...
def dlansvd_irl(which, jobu, jobv, m, n, p, neig, maxiter, aprod, u, v, tolin, work, iwork, doption, ioption, dparm, iparm, dim=None, ldu=None, ldv=None, lwork=None, liwork=None, aprod_extra_args=None): # real signature unknown; restored from __doc__
    """
...
class __dpropack_error(Exception):
    # no doc
...
__spec__ = None # (!) real value is "ModuleSpec(name='scipy.sparse.linalg._propack._dpropack', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0xffffac924a60>, origin='/.venv/lib/python3.8/site-packages/scipy/sparse/linalg/_propack/_dpropack.cpython-38-aarch64-linux-gnu.so')"
