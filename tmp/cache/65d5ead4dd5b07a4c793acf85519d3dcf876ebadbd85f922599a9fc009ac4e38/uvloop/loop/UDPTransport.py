...
class UDPTransport(UVBaseTransport):
    # no doc
    def sendto(self, data, addr=None): # real signature unknown; restored from __doc__
        """ UDPTransport.sendto(self, data, addr=None) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ UDPTransport.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ UDPTransport.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabb26840>'
