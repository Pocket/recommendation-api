...
class _SyncSocketWriterFuture(___asyncio.Future):
    # no doc
    def cancel(self): # real signature unknown; restored from __doc__
        """ _SyncSocketWriterFuture.cancel(self) """
        pass

    def _SyncSocketWriterFuture__remove_writer(self, *args, **kwargs): # real signature unknown
        """ _SyncSocketWriterFuture.__remove_writer(self) """
        pass

    def __init__(self, sock, loop): # real signature unknown; restored from __doc__
        """ _SyncSocketWriterFuture.__init__(self, sock, loop) """
        pass
