...
class UVTimer(UVHandle):
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ UVTimer.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ UVTimer.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabb25d50>'
