...
from .UVStreamServer import UVStreamServer

class UnixServer(UVStreamServer):
    # no doc
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ UnixServer.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ UnixServer.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabb264e0>'
