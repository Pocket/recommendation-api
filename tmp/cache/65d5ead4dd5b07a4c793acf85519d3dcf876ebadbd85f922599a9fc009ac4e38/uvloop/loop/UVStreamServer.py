...
class UVStreamServer(UVSocketHandle):
    # no doc
    ...
    def __on_ssl_connected(self, transport, fut): # real signature unknown; restored from __doc__
        """ UVStreamServer.__on_ssl_connected(self, transport, fut) """
        pass

    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ UVStreamServer.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ UVStreamServer.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabb263f0>'
