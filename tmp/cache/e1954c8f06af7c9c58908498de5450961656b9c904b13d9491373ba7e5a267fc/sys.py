...
version = '3.8.18 (default, Nov  1 2023, 11:08:38) \n[GCC 12.2.0]'

_base_executable = '/.venv/bin/python3'
...
implementation = None # (!) real value is "namespace(_multiarch='aarch64-linux-gnu', cache_tag='cpython-38', hexversion=50860784, name='cpython', version=sys.version_info(major=3, minor=8, micro=18, releaselevel='final', serial=0))"
...
meta_path = [
    None, # (!) real value is '<_distutils_hack.DistutilsMetaFinder object at 0xffffaccf2370>'
    None, # (!) real value is '<_virtualenv._Finder object at 0xffffaccf2190>'
    __loader__,
    None, # (!) real value is "<class '_frozen_importlib.FrozenImporter'>"
    None, # (!) real value is "<class '_frozen_importlib_external.PathFinder'>"
    None, # (!) real value is '<six._SixMetaPathImporter object at 0xffffac90d130>'
]
...
path = [
    '/opt/.pycharm_helpers',
    '/opt/.pycharm_helpers/generator3',
    '/opt/.pycharm_helpers',
...
path_hooks = [
    ...
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0xffffacf96dc0>'
]
