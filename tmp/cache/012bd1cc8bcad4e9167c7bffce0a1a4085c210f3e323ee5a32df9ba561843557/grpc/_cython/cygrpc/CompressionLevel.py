...
class CompressionLevel(object):
    ...
    medium = 2
    none = 0
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', 'none': 0, 'low': 1, 'medium': 2, 'high': 3, '__dict__': <attribute '__dict__' of 'CompressionLevel' objects>, '__weakref__': <attribute '__weakref__' of 'CompressionLevel' objects>, '__doc__': None})"
