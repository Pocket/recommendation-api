...
class RequestCallEvent(BaseEvent):
    ...
    call_details = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    completion_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    invocation_metadata = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
