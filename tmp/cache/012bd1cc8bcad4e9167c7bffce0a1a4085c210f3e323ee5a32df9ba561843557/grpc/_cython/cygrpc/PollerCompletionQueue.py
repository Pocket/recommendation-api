...
class PollerCompletionQueue(BaseCompletionQueue):
    # no doc
    def bind_loop(self, *args, **kwargs): # real signature unknown
        pass

    def _handle_events(self, *args, **kwargs): # real signature unknown
        pass

    def _poll_wrapper(self, *args, **kwargs): # real signature unknown
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd66ed0>'
