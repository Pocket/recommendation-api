...
class PropagationConstants(object):
    # no doc
    ...
    GRPC_PROPAGATE_DEFAULTS = 65535
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', 'GRPC_PROPAGATE_DEADLINE': 1, 'GRPC_PROPAGATE_CENSUS_STATS_CONTEXT': 2, 'GRPC_PROPAGATE_CENSUS_TRACING_CONTEXT': 4, 'GRPC_PROPAGATE_CANCELLATION': 8, 'GRPC_PROPAGATE_DEFAULTS': 65535, '__dict__': <attribute '__dict__' of 'PropagationConstants' objects>, '__weakref__': <attribute '__weakref__' of 'PropagationConstants' objects>, '__doc__': None})"
