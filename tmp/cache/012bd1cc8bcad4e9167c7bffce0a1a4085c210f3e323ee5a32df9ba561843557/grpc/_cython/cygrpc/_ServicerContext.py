...
class _ServicerContext(object):
    # no doc
    def abort(self, *args, **kwargs): # real signature unknown
        pass

    def abort_with_status(self, *args, **kwargs): # real signature unknown
        pass

    def add_done_callback(self, *args, **kwargs): # real signature unknown
        pass

    def auth_context(self, *args, **kwargs): # real signature unknown
        pass

    def cancelled(self, *args, **kwargs): # real signature unknown
        pass

    def code(self, *args, **kwargs): # real signature unknown
        pass

    def details(self, *args, **kwargs): # real signature unknown
        pass

    def disable_next_message_compression(self, *args, **kwargs): # real signature unknown
        pass

    def done(self, *args, **kwargs): # real signature unknown
        pass

    def invocation_metadata(self, *args, **kwargs): # real signature unknown
        pass

    def peer(self, *args, **kwargs): # real signature unknown
        pass

    def peer_identities(self, *args, **kwargs): # real signature unknown
        pass

    def peer_identity_key(self, *args, **kwargs): # real signature unknown
        pass

    def read(self, *args, **kwargs): # real signature unknown
        pass

    def send_initial_metadata(self, *args, **kwargs): # real signature unknown
        pass

    def set_code(self, *args, **kwargs): # real signature unknown
        pass

    def set_compression(self, *args, **kwargs): # real signature unknown
        pass

    def set_details(self, *args, **kwargs): # real signature unknown
        pass

    def set_trailing_metadata(self, *args, **kwargs): # real signature unknown
        pass

    def time_remaining(self, *args, **kwargs): # real signature unknown
        pass

    def trailing_metadata(self, *args, **kwargs): # real signature unknown
        pass
