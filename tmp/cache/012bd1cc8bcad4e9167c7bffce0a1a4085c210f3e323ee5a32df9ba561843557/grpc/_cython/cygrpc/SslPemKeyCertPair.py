...
class SslPemKeyCertPair(object):
    # no doc
    ...
    certificate_chain = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    private_key = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
