...
class WriteFlag(object):
    ...
    buffer_hint = 1
    no_compress = 2
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', 'buffer_hint': 1, 'no_compress': 2, '__dict__': <attribute '__dict__' of 'WriteFlag' objects>, '__weakref__': <attribute '__weakref__' of 'WriteFlag' objects>, '__doc__': None})"
