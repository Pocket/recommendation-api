...
class CompressionOptions(object):
    # no doc
    def disable_algorithm(self, *args, **kwargs): # real signature unknown
        pass

    def enable_algorithm(self, *args, **kwargs): # real signature unknown
        pass

    def is_algorithm_enabled(self, *args, **kwargs): # real signature unknown
        pass

    def to_channel_arg(self, *args, **kwargs): # real signature unknown
        pass
