...
class _BatchOperationTag(_Tag):
    ...
    _operations = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _retained_call = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd66d80>'
