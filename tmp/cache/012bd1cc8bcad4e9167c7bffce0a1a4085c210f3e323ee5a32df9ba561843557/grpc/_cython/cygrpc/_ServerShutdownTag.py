...
class _ServerShutdownTag(_Tag):
    ...
    _shutting_down_server = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _user_tag = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd66de0>'
