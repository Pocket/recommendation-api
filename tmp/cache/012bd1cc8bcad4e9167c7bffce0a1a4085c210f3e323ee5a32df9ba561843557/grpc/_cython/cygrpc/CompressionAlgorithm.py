...
class CompressionAlgorithm(object):
    ...
    gzip = 2
    none = 0
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', 'none': 0, 'deflate': 1, 'gzip': 2, '__dict__': <attribute '__dict__' of 'CompressionAlgorithm' objects>, '__weakref__': <attribute '__weakref__' of 'CompressionAlgorithm' objects>, '__doc__': None})"
