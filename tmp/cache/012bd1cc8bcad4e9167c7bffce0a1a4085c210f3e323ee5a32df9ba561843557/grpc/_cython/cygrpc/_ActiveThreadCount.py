...
class _ActiveThreadCount(object):
    # no doc
    def await_zero_threads(self, *args, **kwargs): # real signature unknown
        pass

    def decrement(self, *args, **kwargs): # real signature unknown
        pass

    def increment(self, *args, **kwargs): # real signature unknown
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', '__init__': <cyfunction _ActiveThreadCount.__init__ at 0xffffaafb41e0>, 'increment': <cyfunction _ActiveThreadCount.increment at 0xffffaafb4380>, 'decrement': <cyfunction _ActiveThreadCount.decrement at 0xffffaafb4450>, 'await_zero_threads': <cyfunction _ActiveThreadCount.await_zero_threads at 0xffffaafb4520>, '__dict__': <attribute '__dict__' of '_ActiveThreadCount' objects>, '__weakref__': <attribute '__weakref__' of '_ActiveThreadCount' objects>, '__doc__': None})"
