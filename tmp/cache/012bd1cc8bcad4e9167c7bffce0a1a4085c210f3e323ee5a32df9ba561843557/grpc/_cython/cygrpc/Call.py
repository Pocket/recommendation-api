...
class Call(object):
    ...
    def start_client_batch(self, *args, **kwargs): # real signature unknown
        pass

    def start_server_batch(self, *args, **kwargs): # real signature unknown
        pass

    def _custom_op_on_c_call(self, *args, **kwargs): # real signature unknown
        pass

    def _start_batch(self, *args, **kwargs): # real signature unknown
        pass
