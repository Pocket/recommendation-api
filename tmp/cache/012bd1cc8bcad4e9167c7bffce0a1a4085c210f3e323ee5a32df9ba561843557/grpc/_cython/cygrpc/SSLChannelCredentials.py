...
class SSLChannelCredentials(ChannelCredentials):
    ...
    _certificate_chain = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _pem_root_certificates = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _private_key = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd66450>'
