...
class LocalConnectionType(object):
    # no doc
    ...
    local_tcp = 1
    uds = 0
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'grpc._cython.cygrpc', 'uds': 0, 'local_tcp': 1, '__dict__': <attribute '__dict__' of 'LocalConnectionType' objects>, '__weakref__': <attribute '__weakref__' of 'LocalConnectionType' objects>, '__doc__': None})"
