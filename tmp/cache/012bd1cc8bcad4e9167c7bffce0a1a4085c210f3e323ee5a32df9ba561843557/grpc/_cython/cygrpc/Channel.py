...
class Channel(object):
    ...
    def close_on_fork(self, *args, **kwargs): # real signature unknown
        pass

    def integrated_call(self, *args, **kwargs): # real signature unknown
        pass

    def next_call_event(self, *args, **kwargs): # real signature unknown
        pass

    def segregated_call(self, *args, **kwargs): # real signature unknown
        pass
