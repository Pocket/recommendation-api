...
class MetadataPluginCallCredentials(CallCredentials):
    ...
    _metadata_plugin = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd66300>'
