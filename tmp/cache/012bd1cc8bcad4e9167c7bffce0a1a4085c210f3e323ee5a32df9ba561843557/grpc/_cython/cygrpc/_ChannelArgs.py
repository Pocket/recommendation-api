...
class _ChannelArgs(object):
    ...
    _arguments = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _references = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd660f0>'
