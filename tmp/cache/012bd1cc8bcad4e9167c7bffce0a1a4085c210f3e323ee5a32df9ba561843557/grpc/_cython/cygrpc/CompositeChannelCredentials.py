...
class CompositeChannelCredentials(ChannelCredentials):
    ...
    _call_credentialses = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _channel_credentials = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd664b0>'
