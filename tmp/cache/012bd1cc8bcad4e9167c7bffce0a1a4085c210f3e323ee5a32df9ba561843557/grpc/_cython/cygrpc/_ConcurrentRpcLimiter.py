...
class _ConcurrentRpcLimiter(object):
    # no doc
    def check_before_request_call(self, *args, **kwargs): # real signature unknown
        pass

    def decrease_once_finished(self, *args, **kwargs): # real signature unknown
        pass

    def _decrease_active_rpcs_count(self, *args, **kwargs): # real signature unknown
        pass

    def _decrease_active_rpcs_count_with_lock(self, *args, **kwargs): # real signature unknown
        pass
