...
class Server(object):
    # no doc
    def add_http2_port(self, *args, **kwargs): # real signature unknown
        pass

    def cancel_all_calls(self, *args, **kwargs): # real signature unknown
        pass

    def destroy(self, *args, **kwargs): # real signature unknown
        pass

    def register_completion_queue(self, *args, **kwargs): # real signature unknown
        pass

    def request_call(self, *args, **kwargs): # real signature unknown
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd66c00>'
