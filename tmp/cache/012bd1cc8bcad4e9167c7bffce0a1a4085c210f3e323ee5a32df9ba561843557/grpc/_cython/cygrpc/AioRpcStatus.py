...
class AioRpcStatus(Exception):
    ...
    def debug_error_string(self, *args, **kwargs): # real signature unknown
        pass
    ...
    _code = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _debug_error_string = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _details = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    _trailing_metadata = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabd66f30>'
