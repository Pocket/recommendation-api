# encoding: utf-8
# module yaml._yaml
# from /.venv/lib/python3.8/site-packages/yaml/_yaml.cpython-38-aarch64-linux-gnu.so
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import yaml as yaml # /.venv/lib/python3.8/site-packages/yaml/__init__.py
...
class CParser(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0xffffabbd0d80>'
