...
service = {
    'domain': 'recommendation-api.readitlater.com' if os.getenv(
        'ENVIRONMENT') == 'production' else 'recommendation-api.getpocket.dev'
}
...
dynamodb = {
    ...
    'recommendation_api_clickdata_table': os.getenv('EXPLORE_TOPICS_CLICKDATA_TABLE', 'explore_topics_clickdata')
}
