...
Thank you for checking out our Recommendation API work. We welcome contributions from everyone! By participating in this project, you agree to abide by the Mozilla [Community Participation Guidelines](https://www.mozilla.org/about/governance/policies/participation/).

### Asking questions / receiving updates

* Slack channel (Mozilla staff only): #team-pocket-backend

* File issues/questions on Github: [https://github.com/Pocket/recommendation-api/issues](https://github.com/Pocket/recommendation-api/issues). We typically triage new issues every Monday.
...
Please review the [development setup docs](https://github.com/Pocket/recommendation-api/blob/main/docs/development.md) for instructions on setting up your development environment, installing dependencies and running tests.
